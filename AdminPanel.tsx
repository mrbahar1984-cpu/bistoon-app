...
import { RefreshCcw, ShieldAlert, Check, X, Trash2, Settings, FileText, UserCheck, Download, Clock, Edit2, Printer, Plus, Calendar } from 'lucide-react';
...
const AdminPanel: React.FC = () => {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      // پیدا کردن موظفی ماه جاری از لیست
  ...
  const submitManualLog = async () => {
    ...
    setLoading(true);
    // استانداردسازی تاریخ و ساعت به اعداد انگلیسی
      ...
      <div className="grid md:grid-cols-12 gap-8">
        <div className="md:col-span-4 space-y-6 no-print">
           ...
           <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100">
              ...
              <div className="space-y-3">
                 ...
                 <input className="w-full p-3 bg-slate-50 rounded-xl text-[10px] font-mono text-center" value={manualLog.date} onChange={e => setManualLog({...manualLog, date: e.target.value})} placeholder="مثلاً ۱۴۰۳/۰۵/۱۲" />
                 <div className="flex gap-2">
        ...
        <div className="md:col-span-8 space-y-6">
           ...
           <section className="no-print bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100">
              <div className="flex items-center gap-2 font-black text-slate-700 mb-6"><Calendar size={18}/> فیلتر و جستجوی هوشمند</div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                 <div className="space-y-1">
                   <label className="text-[9px] font-black text-slate-400 mr-1">از تاریخ</label>
                 ...
                 <div className="space-y-1">
                   <label className="text-[9px] font-black text-slate-400 mr-1">تا تاریخ</label>
