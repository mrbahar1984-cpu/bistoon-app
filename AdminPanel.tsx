...
const AdminPanel: React.FC = () => {
  ...
  const generateDynamoReport = async () => {
    ...
    Object.keys(grouped).forEach(key => {
      ...
      // Calculate pairs for clock in/out
    ...
    <div className="flex flex-col lg:flex-row min-h-screen -m-8">
      ...
      <main className="flex-1 p-6 lg:p-10 bg-slate-50/50 overflow-x-hidden">
        ...
        {activeMenu === 'DYNAMO_REPORTS' && (
          <div className="space-y-6">
            <div className="bg-white p-10 rounded-[3rem] shadow-sm border flex flex-col md:flex-row gap-6 items-end no-print">
              <div className="flex-1 space-y-2 w-full">
                <label className="text-[11px] font-black text-slate-400 mr-2 tracking-widest uppercase">از تاریخ (شمسی)</label>
              ...
              <div className="flex-1 space-y-2 w-full">
                <label className="text-[11px] font-black text-slate-400 mr-2 tracking-widest uppercase">تا تاریخ (شمسی)</label>
