...
const AdminPanel: React.FC = () => {
  ...
  // قابلیت Real-time برای مشاهده آنی تغییرات تلگرام در پنل مدیریت
  useEffect(() => {
    if (!adminAuth) return;
    
    const channel = supabase
      .channel('admin-req-updates')
      .on(
        'postgres_changes',
        { event: '*', schema: 'public', table: 'leave_requests' },
        () => {
          // در صورت هرگونه تغییر (توسط تلگرام یا سایر مدیران)، لیست را بروزرسانی کن
          fetchData();
        }
      )
      .subscribe();
