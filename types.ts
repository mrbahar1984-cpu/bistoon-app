...
export type LeaveType = 'DAILY_LEAVE' | 'HOURLY_PASS' | 'REMOTE_WORK' | 'CORRECT_LOG';
...
export interface AttendanceLog {
  ...
  time: string;
  is_manual?: boolean;
  // Fix: Added employees property for joined queries where employee name is fetched alongside the log
  employees?: { name: string; national_id?: string };
}
