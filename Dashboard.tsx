      ...
      <div className="max-w-md mx-auto mt-12 px-4">
        <div className="bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100">
          ...
          <div className="space-y-4">
            <input className="w-full p-4 rounded-2xl bg-slate-50 border border-slate-100 outline-none focus:border-emerald-500" placeholder="کد ملی" value={formData.nationalId} onChange={e => setFormData({...formData, nationalId: e.target.value})} />
            <input type="password" className="w-full p-4 rounded-2xl bg-slate-50 border border-slate-100 outline-none focus:border-emerald-500" placeholder="رمز عبور" value={formData.password} onChange={e => setFormData({...formData, password: e.target.value})} />
            <p className="text-[10px] text-slate-400 text-center px-4 leading-relaxed">برای اولین ورود، اطلاعات خود را وارد کنید. در صورت عدم وجود حساب، ابتدا با ادمین هماهنگ کنید.</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="md:col-span-8 space-y-6">
          <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center justify-between">
             ...
             <div className="bg-slate-50 p-3 rounded-2xl flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-slate-600">ارتباط با سرور برقرار است</span>
             </div>
          </div>
