...
import { getShamsiDate, getShamsiTime, getDayName, toEnglishDigits, getCurrentMonthRange, parseShamsiDate, shamsiMonthNames, formatShamsiDate, isHoliday } from './jalali';
import { calculateMonthPerformance, MonthPerformanceStats } from './calculations';
            ...
            <div className="space-y-6 animate-in fade-in">
              {pastMonthsStats.length === 0 ? (
                ...
                <>
                  ...
                  {/* کارت‌های خلاصه عملکرد ماه گذشته انتخاب‌شده (دقیقاً مشابه ساختار میز کار) */}
                  {activePastMonthStats && (
                    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950 text-white p-6 md:p-8 rounded-[3rem] shadow-xl border border-slate-700/50 space-y-6">
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pb-5 border-b border-slate-700/60 gap-3">
                        <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-[11px] font-black bg-white/10 px-3.5 py-1.5 rounded-xl border border-white/10 text-indigo-300 font-mono">
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white/5 backdrop-blur-md p-5 rounded-3xl border border-white/10 hover:border-emerald-500/40 transition-all flex flex-col justify-between">
                          <div className="flex items-center justify-between text-slate-400 mb-2">
                            <span className="text-xs font-black">کارکرد کل ماه</span>
                            <Clock size={18} className="text-emerald-400" />
                          </div>
                          <div className="text-base md:text-xl font-black text-emerald-400 font-mono my-1">
