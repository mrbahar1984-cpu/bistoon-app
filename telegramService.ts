...
/**
 * راهنمای رفع مشکل دکمه‌ها:
 * اگر دکمه‌ها کار نمی‌کنند، کد Edge Function را با نسخه جدید (که در پیام چت ارسال شد) جایگزین کنید.
 * این نسخه جدید شامل پاسخ فوری (answerCallbackQuery) است که مشکل گیر کردن دکمه را حل می‌کند.
 * 
 * لینک فعال‌سازی مجدد (در صورت نیاز):
